...
const (
	DbService_Select_FullMethodName                          = "/database.dbService/Select"
	DbService_Insert_FullMethodName                          = "/database.dbService/Insert"
	DbService_GetMessage_FullMethodName                      = "/database.dbService/GetMessage"
	DbService_GetUnviewedMessagesForReminders_FullMethodName = "/database.dbService/GetUnviewedMessagesForReminders"
	DbService_LogReminderSent_FullMethodName                 = "/database.dbService/LogReminderSent"
	DbService_GetReminderHistory_FullMethodName              = "/database.dbService/GetReminderHistory"
	DbService_Ping_FullMethodName                            = "/database.dbService/Ping"
)
...
func (c *dbServiceClient) Ping(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (UnimplementedDbServiceServer) Ping(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
...
func _DbService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DbServiceServer).Ping(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DbService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "database.dbService",
