...
// ValidationPort defines the secondary port for validation operations in the storage domain.
// This interface abstracts validation logic from the domain, allowing for flexible validation
// rules and sanitization strategies. It ensures that storage-related data meets security
...
type ValidationPort interface {
	...
	//   - "alice@company.org" -> "a***e@company.org"
	//   - Invalid emails might return "[INVALID_EMAIL_FORMAT]"
