...
type PassConfig struct {
	...
	FileUploadMaxSize      int64  `mapstructure:"fileuploadmaxsize"`
	ObjectStorageEndpoint  string `mapstructure:"objectstorageendpoint"`
	ObjectStorageAccessKey string `mapstructure:"objectstorageaccesskey"`
	ObjectStorageSecretKey string `mapstructure:"objectstoragesecretkey"`
	ObjectStorageBucket    string `mapstructure:"objectstoragebucket"`
	ObjectStorageUseSSL    bool   `mapstructure:"objectstorageusessl"`
